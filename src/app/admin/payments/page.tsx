            ...
            <div className="bg-[#1D1D23] text-white space-y-8 min-h-screen">
                <div className='px-4 flex flex-row justify-between items-center'>
                    <div>
                        ...
                        <Text as='p'>Total Payment: $1200.20k</Text>
                    </div>
                        ...
                        {filteredUsers.length === 0 ? (
                            ...
                            <div>
                                ...
                                <div className="py-3 px-2 flex justify-between items-center text-sm text-[#FFFFFF80] border-b border-gray-600 pb-7">
                                    <div className="w-1/4 text-start text-base text-[#FFFFFF] font-medium">Payment ID</div>
                                    <div className="w-1/4 text-center text-base text-[#FFFFFF] font-medium">File Name</div>
                                    <div className="w-1/4 text-center text-base text-[#FFFFFF] font-medium">Payment By</div>
                                    <div className="w-1/4 text-center text-base text-[#FFFFFF] font-medium">Trace Type</div>
                                    <div className="w-1/4 text-center text-base text-[#FFFFFF] font-medium">Total Charges</div>
                                    <div className="w-1/4 text-center text-base text-[#FFFFFF] font-medium">Payment On</div>
                                </div>
