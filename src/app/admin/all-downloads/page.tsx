        ...
        <div className="bg-[#1D1D23]">
          <div className="bg-[#1D1D23] p-5 rounded-xl">
            {filteredUsers.length === 0 ? (
              <div className="text-center text-[#FFFFFF80] py-10">
                No users found.
              </div>
            ) : (
              <div>
                ...
                <div className="py-3 px-2 flex justify-between items-center text-sm text-[#FFFFFF80] border-b border-gray-600 pb-7">
                  <div className="w-1/4 text-start text-base text-[#FFFFFF] font-medium">
                    User Name
                  </div>
                  <div className="w-1/4 text-center text-base text-[#FFFFFF] font-medium">
                    Email Address
                  </div>
                  <div className="w-1/4 text-center text-base text-[#FFFFFF] font-medium">
                    Added on
                  ...
                  {filteredUsers.map((user, i) => (
                    ...
                    >
                      ...
                      <div className="w-1/4 text-center">
                        <button className="text-[#A8E543] hover:underline">
                          View Details
                        </button>
                      </div>
                    </div>
            ...
            {[1, 2, 3, 4, 5, 6].map((page) => (
              <button
                ...
                className={`w-8 h-8 rounded-lg text-sm flex items-center justify-center ${
                  page === 1
                    ? 'bg-[#A8E543] text-black'
                    : 'text-white hover:text-[#A8E543]'
                }`}
              >
                {page}
              </button>
